...
import { useThermalPanels, ThermalPhotoBox } from './ThermalPhotos';
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const b7_panels = useThermal
        ? await thermalApi.buildPanels(measureSets.length)
        : undefined;
