'use client';
// ============================================================
// app/(auth)/login/page.tsx — 로그인 페이지 v4 (Suspense 추가)
// ============================================================
...
// 메인 페이지 컴포넌트 - Suspense로 감싸서 useSearchParams 지원
export default function LoginPage() {
  return (
    <div style={{
      ...
      <Suspense fallback={
        <div style={{ textAlign: 'center', color: '#4b5563', fontSize: 14 }}>로딩 중...</div>
      }>
        <LoginContent />
      </Suspense>
    </div>
